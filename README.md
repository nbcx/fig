...
_NOTE [since 1.6]:_ You can also have a file without an extension and specify the format programmatically. For those configuration files that lie in the home of the user without any extension like `.bashrc`
...
The use of [pflag](https://github.com/nbcx/flag/) in Viper does not preclude
